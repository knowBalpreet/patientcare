...
<div class="patients view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= h($patient->created->nice()) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Modified') ?></th>
            <td><?= h($patient->modified->nice()) ?></td>
        </tr>
    </table>
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($appointments->appointment_date->nice()) ?></td>
                <td class="actions">
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($invoices->due->nice()) ?></td>
                <td><?= h($invoices->created->nice()) ?></td>
                <td class="actions">
